import { cancelBooking } from "@/app/services/patientAppointmentBooking.service";
import {
  CalendarIcon,
  ClockIcon,
  MapPinIcon,
      ...
      <div className=" flex flex-col md:flex-row items-start justify-between">
        <div className="flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div className="flex items-center gap-2 text-gray-600">
              ...
              <span>{appointment.slot.slot}</span>
            </div>
        ...
        <div className="flex flex-row md:flex-col  gap-2 ml-4">
          ...
          {appointment.status === "completed" ? (
            ...
            <button
              className="px-4 py-2 border border-teal-600 global-text-color-teal rounded-lg hover:bg-blue-50 transition-colors"
