...
import { RiArrowDropDownLine } from "react-icons/ri";
  const UserDropdown = ({ isMobile = false , handleUserAction , dropdownRef, userDetails}) => (
    <div
    ...
    >
      <div className={`flex items-center ${isMobile ? "gap-2" : ""}`}>
        <button
          className="bg-teal-500 text-white p-2 rounded-full hover:bg-teal-600 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-teal-300 cursor-pointer"
      ...
      >
        <div className="w-48">
          <div className="px-4 py-3 border-b border-gray-200 flex items-center justify-between">
            ...
            <button
              className="text-2xl text-gray-400 hover:text-teal-600 transition-colors duration-150 focus:outline-none"
