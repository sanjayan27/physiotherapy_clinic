...
const HandleMobileView = ({isMobile= false}) => {
    ...
    return (
      <div className={`flex items-center ${isMobile ? "gap-2" : ""}`}>
        <button
          className="bg-teal-500 text-white p-2 rounded-full hover:bg-teal-600 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-teal-300"
